...
class galleryPermission(BasePermission):
    def has_permission(self, request, view):
        ...
        # Check if user has permission to retrieve the gallery item
            ...
            return request.user.has_perm('gallery.view_gallery')

        # Check if user has permission to create or update the gallery item
        elif view.action in ["create", "update"]:
            return request.user.has_perm('gallery.change_gallery')
        ...
        # Check if user has permission to delete the gallery item
            ...
            return request.user.has_perm('gallery.delete_gallery')
