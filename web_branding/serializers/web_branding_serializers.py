...
from ..models import Position, WebBranding, WebBrandingCategory



class WebBrandingCategoryListSerializers(serializers.ModelSerializer):
    class Meta:
        model = WebBrandingCategory
        fields = '__all__'

class WebBrandingCategoryRetrieveSerializers(serializers.ModelSerializer):
    class Meta:
        model = WebBrandingCategory
        fields = '__all__'

class WebBrandingCategoryWriteSerializers(serializers.ModelSerializer):
    class Meta:
        model = WebBrandingCategory
        fields = '__all__'
    ...
    def validate_name(self, value):
        ...
        """
        qs = WebBrandingCategory.objects.filter(name__iexact=value)
        if self.instance:
...
class WebBrandingWriteSerializers(serializers.ModelSerializer):
    class Meta:
        model = WebBranding
        fields = '__all__'
