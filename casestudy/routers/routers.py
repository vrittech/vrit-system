...
router.register('casestudytags', casestudytagsViewsets, basename="casestudytagsViewsets")
router.register('casestudycategory', casestudycategoryViewsets, basename="casestudycategoryViewsets")
